    ...
    return (
        <footer className="m-10 mt-60">
            <div className="flex flex-col justify-items-center content-center gap-4 md:justify-stretch md:flex-row">
                <p className="self-center italic text-center md:text-left grow">Made By Mohammed Akinbayo</p>
                <div className="flex place-self-center justify-self-center justify-items-center order-last md:order-0 grow">
