    ...
    return (
        <footer className="m-10 mt-60">
            <div className="flex flex-col justify-items-center content-center gap-4 md:justify-between md:flex-row">
                <p className="self-center italic text-center grow md:text-left md:w-sm">Made By Mohammed Akinbayo</p>
                <div className="flex place-self-center justify-self-center justify-items-center order-last grow md:order-0 md:justify-center md">
